...
public class BookNowCelerioX extends AppCompatActivity implements OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_now_celerio_x);

        Toolbar toolbar = findViewById(R.id.toolbar_bookNowCelerio);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("CelerioX 2019");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        button_3 = (Button)findViewById(R.id.selectPayment);
        ...
        editText.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(BookNowCelerioX.this, new OnDateSetListener() {
                    @Override
