...
public class BookNowMazda6 extends AppCompatActivity implements OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_now_mazda6);

        Toolbar toolbar = findViewById(R.id.toolbar_bookNowMazda);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Mazda 6 2019");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        button_5 = (Button)findViewById(R.id.selectPayment);
        ...
        editText.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(BookNowMazda6.this, new OnDateSetListener() {
                    @Override
