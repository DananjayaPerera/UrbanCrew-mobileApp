...
public class BookNowSwift extends AppCompatActivity implements OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_now_swift);

        Toolbar toolbar = findViewById(R.id.toolbar_bookNowSwift);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Swift 2019");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        button_2 = (Button)findViewById(R.id.selectPayment);
        ...
        editText.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(BookNowSwift.this, new OnDateSetListener() {
                    @Override
