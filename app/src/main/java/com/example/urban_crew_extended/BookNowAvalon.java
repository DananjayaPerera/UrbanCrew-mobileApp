...
public class BookNowAvalon extends AppCompatActivity implements OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_now_avalon);

        Toolbar toolbar = findViewById(R.id.toolbar_bookNowAvalon);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Avalon 2019");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        button_6 = (Button)findViewById(R.id.selectPayment);
        ...
        editText.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(BookNowAvalon.this, new OnDateSetListener() {
                    @Override
