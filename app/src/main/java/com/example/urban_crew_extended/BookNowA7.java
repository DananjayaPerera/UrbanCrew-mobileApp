...
public class BookNowA7 extends AppCompatActivity implements OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_now_a7);

        Toolbar toolbar = findViewById(R.id.toolbar_bookNowA7);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("A7 2019");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        button_7 = (Button)findViewById(R.id.selectPayment);
        ...
        editText.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(BookNowA7.this, new OnDateSetListener() {
                    @Override
