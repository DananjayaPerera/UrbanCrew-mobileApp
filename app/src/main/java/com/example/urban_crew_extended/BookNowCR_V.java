...
public class BookNowCR_V extends AppCompatActivity implements OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_now_cr__v);

        Toolbar toolbar = findViewById(R.id.toolbar_bookNowCR_V);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("CR-V 2019");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        button_9 = (Button)findViewById(R.id.selectPayment);
        ...
        editText.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(BookNowCR_V.this, new OnDateSetListener() {
                    @Override
