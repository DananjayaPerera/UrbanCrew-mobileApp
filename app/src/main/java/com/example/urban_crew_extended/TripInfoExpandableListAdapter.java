...
public class TripInfoExpandableListAdapter extends BaseExpandableListAdapter {


    private HashMap<String, List<String>> mStringListHashMap;
    private String [] mListHeaderGroup;

    public TripInfoExpandableListAdapter(HashMap<String, List<String>> mStringListHashMap) {
        this.mStringListHashMap = mStringListHashMap;
        mListHeaderGroup = this.mStringListHashMap.keySet().toArray(new String[0]);
    }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            ...
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.trip_info_expandable_group, parent,false);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            ...
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.trip_info, parent, false);
