...
public class BookNowWagonR extends AppCompatActivity implements OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_now_wagon_r);

        Toolbar toolbar = findViewById(R.id.toolbar_bookNowWagon);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("WagonR 2019");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        button_4 = (Button)findViewById(R.id.selectPayment);
        ...
        editText.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(BookNowWagonR.this, new OnDateSetListener() {
                    @Override
