...
public class BookNowM760Li extends AppCompatActivity implements OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_now_m760_li);

        Toolbar toolbar = findViewById(R.id.toolbar_bookNowM760Li);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("M760Li 2019");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        button_8 = (Button)findViewById(R.id.selectPayment);
        ...
        editText.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(BookNowM760Li.this, new OnDateSetListener() {
                    @Override
