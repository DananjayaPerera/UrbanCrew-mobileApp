...
public class BookNowV8 extends AppCompatActivity implements OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_now_v8);

        Toolbar toolbar = findViewById(R.id.toolbar_bookNowV8);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Land Cruiser V8 2019");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        button_11 = (Button)findViewById(R.id.selectPayment);
        ...
        editText.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(BookNowV8.this, new OnDateSetListener() {
                    @Override
