...
public class BookNowXTrail extends AppCompatActivity implements OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_now_xtrail);

        Toolbar toolbar = findViewById(R.id.toolbar_bookNowXTrail);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("X-Trail 2019");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        button_10 = (Button)findViewById(R.id.selectPayment);
        ...
        editText.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(BookNowXTrail.this, new OnDateSetListener() {
                    @Override
